...
namespace CATHODE::EntityInterface
{
	...
	bool __fastcall hFindParameterBool(void* _this, void* _EDX, DataTypes::MemoryPtr* entity_ptr, DataTypes::ShortGuid* shortguid_ptr, bool* bool_val);
	...
	bool __fastcall hFindParameterFloat(void* _this, void* _EDX, DataTypes::MemoryPtr* entity_ptr, DataTypes::ShortGuid* shortguid_ptr, float* float_val);
