...
{
	typedef int(__thiscall* t_call_entity_method)(void* _this, DataTypes::ShortGuid* param_1, char* param_2, int* param_3, int param_4);
	inline auto call_entity_method = reinterpret_cast<t_call_entity_method>(DEVTOOLS_RELATIVE_ADDRESS(0x0091d9f0 - 0x00400000));
	int  __fastcall h_call_entity_method(void* _this, void* _EDX, DataTypes::ShortGuid* param_1, char* param_2, int* param_3, int param_4)
	{
